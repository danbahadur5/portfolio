        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="max-w-5xl mx-auto text-center mb-20 px-4">
            <motion.div
              ...
              className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-primary/5 dark:bg-primary/[0.03] text-primary/80 dark:text-primary/60 text-[9px] font-bold uppercase tracking-[0.1em] mb-6 border border-primary/10 dark:border-white/10 backdrop-blur-sm shadow-sm w-fit mx-auto"
            >
